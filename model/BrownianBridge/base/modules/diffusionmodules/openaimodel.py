...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps=None, context=None, y=None, **kwargs):
        ...
        :param timesteps: a 1-D batch of timesteps, or None if unconditional.
        :param context: conditioning plugged in via cross-attn
        ...
        if timesteps is None:
            # 如果t为None，生成零向量embedding
            emb = th.zeros(x.shape[0], self.model_channels * 4, device=x.device, dtype=self.dtype)
        else:
            # 有t的正常情况
