...
def parse_args_and_config():
    ...
    parser.add_argument('-c', '--config', type=str, default='configs/Dual.yaml', help='Path to the config file')
    ...
    parser.add_argument('--resume_model', type=str, default=None, help='results/Cityscapes/DualBrownianBridge/checkpoint/latest_model_60.pth')
    parser.add_argument('--resume_optim', type=str, default=None, help='results/Cityscapes/DualBrownianBridge/checkpoint/latest_optim_sche_60.pth')
