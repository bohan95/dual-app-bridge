#train BBDM
python3 main.py --config configs/Template-LBBDM-f4.yaml --train --sample_at_start --save_top --gpu_ids 1 

#train DBBDM
python3 main.py --config configs/Dual.yaml --train --sample_at_start --save_top --gpu_ids 1 


#test
python3 main.py --config configs/Template-LBBDM-f4.yaml --sample_to_eval --gpu_ids 1 \
